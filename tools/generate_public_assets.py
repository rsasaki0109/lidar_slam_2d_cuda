...
BENCHMARK_CARDS = [
    BenchmarkCard(
        ...
        slamx_label="lidar_slam_2d_cuda parity",
    ...
    BenchmarkCard(
        ...
        slamx_label="lidar_slam_2d_cuda vscan+BB",
...
def _benchmark_summary_svg(cards: list[BenchmarkCard]) -> str:
    ...
    parts = [
        ...
        '<title id="title">lidar_slam_2d_cuda benchmark summary</title>',
        '<desc id="desc">A public benchmark summary comparing reference trajectories against lidar_slam_2d_cuda results across backpack and IILABS datasets.</desc>',
        ...
        '<text x="60" y="78" font-size="42" font-family="Inter,Arial,sans-serif" font-weight="700" fill="#f8fafc">lidar_slam_2d_cuda benchmark summary</text>',
...
def _trajectory_overlay_svg(panels: list[OverlayPanel]) -> str:
    ...
    parts = [
        f'<svg xmlns="http://www.w3.org/2000/svg" width="{width}" height="{height}" viewBox="0 0 {width} {height}" role="img" aria-labelledby="title desc">',
        '<title id="title">lidar_slam_2d_cuda trajectory gallery</title>',
        '<desc id="desc">Overlay panels showing aligned lidar_slam_2d_cuda trajectories against reference trajectories across backpack and IILABS datasets.</desc>',
        ...
        '<text x="60" y="116" font-size="20" font-family="Inter,Arial,sans-serif" fill="#475569">lidar_slam_2d_cuda trajectories are aligned in SE(2) to the reference path for visual comparison.</text>',
        '<rect x="60" y="130" width="14" height="14" rx="7" fill="#2563eb"/>',
        '<text x="84" y="142" font-size="16" font-family="Inter,Arial,sans-serif" fill="#0f172a">lidar_slam_2d_cuda</text>',
